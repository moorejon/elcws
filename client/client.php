...
$token = '156008ca3583046ed0ca5077ed95820e';
$domainname = 'http://localhost:8888/moodle27';

/// FUNCTION NAME
$functionname = 'local_elcws_manual_enrol_users_by_name';
...
$curl = new curl;
$post = xmlrpc_encode_request($functionname, array($username,$coursename,$timestart,$timeend,$suspend));
